...
class BasicView extends Ui.WatchFace {
    ...
    function onUpdate(dc) {
      ...
      var bitmaps = [
        Rez.Drawables.cat_01,
        Rez.Drawables.cat_02,
        Rez.Drawables.cat_03,
        Rez.Drawables.cat_04,
        Rez.Drawables.cat_05,
        Rez.Drawables.cat_04,
        Rez.Drawables.cat_03,
        Rez.Drawables.cat_02,
        Rez.Drawables.cat_01,
        ...
        Rez.Drawables.cat_03,
        Rez.Drawables.cat_02,
        Rez.Drawables.cat_06,
        Rez.Drawables.cat_07,
        Rez.Drawables.cat_08,
        Rez.Drawables.cat_09,
        Rez.Drawables.cat_09,
        Rez.Drawables.cat_08,
        Rez.Drawables.cat_07,
        Rez.Drawables.cat_06,
      ...
      // render cat animation
      b_cat = Ui.loadResource(bitmaps[count%bitmaps.size()]);
      dc.drawBitmap(0, 0, b_cat);

      // render the time
      dc.setColor(Gfx.COLOR_BLACK, Gfx.COLOR_TRANSPARENT);
      dc.drawText((dw/2)+2,(dh*4/5)-(dc.getFontHeight(Gfx.FONT_SYSTEM_NUMBER_HOT)/2)+2,Gfx.FONT_SYSTEM_NUMBER_HOT,hour.toString() + ":" + minute.toString(),Gfx.TEXT_JUSTIFY_CENTER);

      dc.setColor(Gfx.COLOR_WHITE, Gfx.COLOR_TRANSPARENT);
      dc.drawText(dw/2,(dh*4/5)-(dc.getFontHeight(Gfx.FONT_SYSTEM_NUMBER_HOT)/2),Gfx.FONT_SYSTEM_NUMBER_HOT,hour.toString() + ":" + minute.toString(),Gfx.TEXT_JUSTIFY_CENTER);
